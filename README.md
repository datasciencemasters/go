 ...
 * Fundamentals of Machine Learning for Predictive Analytics [Book ```$70```](https://mitpress.mit.edu/books/fundamentals-machine-learning-predictive-data-analytics)
 ...
 * Intro to Statistical Learning / Stanford [Digital & Code](http://www-bcf.usc.edu/~gareth/ISL/) & [Book ```$80```](http://www.amazon.com/Introduction-Statistical-Learning-Applications-Statistics/dp/1461471370)
 ...
 * Bayesian Reasoning and Machine Learning [Code](http://web4.cs.ucl.ac.uk/staff/D.Barber/pmwiki/pmwiki.php?n=Brml.Software) / [Book](http://web4.cs.ucl.ac.uk/staff/D.Barber/pmwiki/pmwiki.php?n=Brml.HomePage)
